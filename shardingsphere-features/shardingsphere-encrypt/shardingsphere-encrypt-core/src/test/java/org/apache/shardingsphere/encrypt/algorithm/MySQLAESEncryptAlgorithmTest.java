...
public final class MySQLAESEncryptAlgorithmTest {
    ...
    public void setUp() {
        ...
        props.setProperty("aes-key-value", "key");
    ...
    public void assertEncrypt() {
        assertThat(encryptAlgorithm.encrypt("test"), is("npzkTNnfKyAfUZR+A7zL4g=="));
    }
    ...
    public void assertDecrypt() {
        assertThat(encryptAlgorithm.decrypt("npzkTNnfKyAfUZR+A7zL4g==").toString(), is("test"));
    }
